<template>
  ...
  <el-dialog v-model="activityRemarDialogVisible" title="编辑市场活动备注记录" width="55%" center draggable>
    <el-form ref="editActivityRemarRefForm" :model="editActivityRemarkQuery" label-width="110px"
             :rules="editActivityRemarRules">
...
import {doDelete, doGet, doGet2, doPost, doPost2, doPut} from "../http/httpRequest.js";
import {goBack, messageTip} from "../util/utils.js";
